/*
  ...
  - You are about to drop the column `thumbnail` on the `Music` table. All the data in the column will be lost.
...
CREATE TABLE "new_Artist" (
    "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "title" TEXT NOT NULL,
    "artist_thumbnail" TEXT NOT NULL DEFAULT 'default_user.png',
    "slug" TEXT NOT NULL,
