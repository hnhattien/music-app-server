/*
  ...
  - You are about to alter the column `id` on the `Artist` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `id` on the `ResetPassword` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `id` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `songid` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `userid` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `admin_id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `notification_id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - The primary key for the `Likes` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to alter the column `id` on the `Likes` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `songid` on the `Likes` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `userid` on the `Likes` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - The primary key for the `Category` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to alter the column `id` on the `Category` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `artist_id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `cat_id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `viewcount` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - The primary key for the `Notifications` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to alter the column `id` on the `Notifications` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  ...
  - You are about to alter the column `artist_id` on the `Album` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
  - You are about to alter the column `cat_id` on the `Album` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
