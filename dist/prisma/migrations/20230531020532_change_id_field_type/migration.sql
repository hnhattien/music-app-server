/*
  ...
  - You are about to alter the column `id` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `songid` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `userid` on the `LyricTable` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `artist_id` on the `Album` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `cat_id` on the `Album` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `songid` on the `Likes` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `admin_id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `notification_id` on the `Notifications_Seen` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `id` on the `Notifications` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `expires` on the `ResetPassword` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `id` on the `ResetPassword` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  ...
  - You are about to alter the column `artist_id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `cat_id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
  - You are about to alter the column `id` on the `Music` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
...
INSERT INTO "new_Music" ("artist_id", "artist_name", "audio", "cat_id", "id", "public_year", "slug", "thumbnail", "title", "upload_time", "viewcount") SELECT "artist_id", "artist_name", "audio", coalesce("cat_id", 1) AS "cat_id", "id", "public_year", "slug", "thumbnail", "title", "upload_time", "viewcount" FROM "Music";
DROP TABLE "Music";
